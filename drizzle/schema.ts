import { mysqlTable, mysqlSchema, AnyMySqlColumn, varchar, int, datetime, tinytext, text, date } from "drizzle-orm/mysql-core"
...
export const transactionDetails = mysqlTable("transaction_details", {
	id: varchar("id", { length: 255 }).default(sql`(uuid())`).primaryKey().notNull(),
